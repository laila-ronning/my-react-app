...
Events.on(Events.REMOVE_DEPLOY, function(deployId) {
    console.log('Deploystore on.REMOVE_DEPLOY, remove deployItem with id ', deployId);
    destroy(deployId);
...
Events.on(Events.DEPLOY_CREATE, function(deployId) {
    console.log('Deploystore on.DEPLOY_CREATE, deploy deployItem with id ', deployId);
